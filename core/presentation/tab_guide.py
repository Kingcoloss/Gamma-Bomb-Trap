...
การวัดระยะราคาจากจุด DGC โดยใช้ค่า Standard Deviation (σ)
เพื่อระบุสถานะของเจ้ามือ:

- **1σ** = **Dealer Safe Zone**: MM ยังคงมีกำไร ความต้องการ Hedging เป็นแบบ Elastic
  (ไม่รีบร้อน) ราคาเคลื่อนไหวปกติ → Theta > Gamma Loss → ตลาดนิ่ง, Mean-Revert
- **2σ** = **Hedging Pressure Zone**: ราคาเริ่มทะลุจุด Breakeven (GTBR) รายวัน
  MM เริ่มขาดทุนจาก Gamma → Dealer เริ่ม Rebalance เชิงรุก
- **3σ** = **Inelastic Demand / Panic**: เข้าสู่ "โซนสังหาร" (Kill Zone)
  MM เกิดอาการ Panic ต้องซื้อหรือขาย Futures อย่างบ้าคลั่งโดยไม่สนราคา (Inelastic)
  → Gamma Squeeze / Cascading Sell-off
...
หากอัตราส่วนพุ่งสูง แสดงว่ามี **Opening Block Trade** (สถาบันเปิดสถานะใหม่ปริมาณมหาศาล)
ระหว่างวัน ระดับนี้จะกลายเป็น Kill Zone ทันที เพราะเจ้ามือต้องป้องกันระดับราคานี้อย่างถวายหัว
""")
